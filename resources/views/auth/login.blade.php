    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            width: 100%;
            place-items: center;
            background: -webkit-linear-gradient(left, #619fe0ff, #376ca5ff, #296cb3ff, #0F3F73);
        }
        ...
        .slide-controls .slider-tab {
            ...
            z-index: 0;
            border-radius: 15px;
            background: -webkit-linear-gradient(left, #0F3F73, #0F3F73, #0F3F73, #0F3F73);
            transition: all 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55);
        }
        ...
        form .btn .btn-layer {
            ...
            position: absolute;
            left: -100%;
            background: -webkit-linear-gradient(right, #0F3F73, #0F3F73, #0F3F73, #0F3F73);
            border-radius: 15px;
...
<body>
      ...
      <div class="title-text">
          <div class="title login">Flytrust Login</div>
          <div class="title signup">Flytrust Signup</div>
      </div>
