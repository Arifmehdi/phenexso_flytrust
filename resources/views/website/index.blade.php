                  ...
                  <div class="row">
                    <div class="col-lg-4 responsive-column">
                      <div class="deal-card">
                        <div class="deal-title d-flex align-items-center">
                          <img
                            src="{{ asset('frontend/images/airline-img.png') }}"
                            alt="air-line-img"
                          />
                    ...
                    <div class="col-lg-4 responsive-column">
                      <div class="deal-card">
                        <div class="deal-title d-flex align-items-center">
                          <img
                            src="{{ asset('frontend/images/airline-img2.png') }}"
                            alt="air-line-img"
                          />
                          <h3 class="deal__title">
                            <a
                    ...
                    <div class="col-lg-4 responsive-column">
                      <div class="deal-card">
                        <div class="deal-title d-flex align-items-center">
                          <img
                            src="{{ asset('frontend/images/airline-img3.png') }}"
                            alt="air-line-img"
                          />
                          <h3 class="deal__title">
                            <a
                    ...
                    <div class="col-lg-4 responsive-column">
                      <div class="deal-card">
                        <div class="deal-title d-flex align-items-center">
                          <img
                            src="{{ asset('frontend/images/airline-img4.png') }}"
                            alt="air-line-img"
                          />
                          <h3 class="deal__title">
                            <a
                    ...
                    <div class="col-lg-4 responsive-column">
                      <div class="deal-card">
                        <div class="deal-title d-flex align-items-center">
                          <img
                            src="{{ asset('frontend/images/airline-img5.png') }}"
                            alt="air-line-img"
                          />
                          <h3 class="deal__title">
                            <a
                    ...
                    <div class="col-lg-4 responsive-column">
                      <div class="deal-card">
                        <div class="deal-title d-flex align-items-center">
                          <img
                            src="{{ asset('frontend/images/airline-img6.png') }}"
                            alt="air-line-img"
                          />
                          <h3 class="deal__title">
                            <a
        ...
        <div class="row padding-top-50px">
          <div class="col-lg-4">
            <div class="card-item destination-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/destination-img2.jpg') }}" alt="destination-img" />
            ...
            <div class="card-item destination-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/destination-img3.jpg') }}" alt="destination-img" />
          ...
          <div class="col-lg-4">
            <div class="card-item destination-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/destination-img4.jpg') }}" alt="destination-img" />
            ...
            <div class="card-item destination-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/destination-img5.jpg') }}" alt="destination-img" />
          ...
          <div class="col-lg-4">
            <div class="card-item destination-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/destination-img.jpg') }}" alt="destination-img" />
            ...
            <div class="car-wrap">
              <div class="car-carousel carousel-action">
                <div class="card-item car-card mb-0">
                  <div class="card-img">
                    <a href="car-single.html" class="d-block">
                      <img src="{{ asset('frontend/images/car-img.png') }}" alt="car-img" />
                    </a>
                    <span class="badge">Bestseller</span>
                    <div
                      class="add-to-wishlist icon-element"
                ...
                <div class="card-item car-card mb-0">
                  <div class="card-img">
                    <a href="car-single.html" class="d-block">
                      <img src="{{ asset('frontend/images/car-img2.png') }}" alt="car-img" />
                    </a>
                    <div
                      class="add-to-wishlist icon-element"
                      data-bs-toggle="tooltip"
                ...
                <div class="card-item car-card mb-0">
                  <div class="card-img">
                    <a href="car-single.html" class="d-block">
                      <img src="{{ asset('frontend/images/car-img3.png') }}" alt="car-img" />
                    </a>
                    <span class="badge">featured</span>
                    <div
                      class="add-to-wishlist icon-element"
                ...
                <div class="card-item car-card mb-0">
                  <div class="card-img">
                    <a href="car-single.html" class="d-block">
                      <img src="{{ asset('frontend/images/car-img4.png') }}" alt="car-img" />
                    </a>
                    <span class="badge">Bestseller</span>
                    <div
                      class="add-to-wishlist icon-element"
                ...
                <div class="card-item car-card mb-0">
                  <div class="card-img">
                    <a href="car-single.html" class="d-block">
                      <img src="{{ asset('frontend/images/car-img5.png') }}" alt="car-img" />
                    </a>
                    <div
                      class="add-to-wishlist icon-element"
                      data-bs-toggle="tooltip"
                ...
                <div class="card-item car-card mb-0">
                  <div class="card-img">
                    <a href="car-single.html" class="d-block">
                      <img src="{{ asset('frontend/images/car-img6.png') }}" alt="car-img" />
                    </a>
                    <span class="badge">featured</span>
                    <div
                      class="add-to-wishlist icon-element"
...
================================= -->
    <section class="cta-area padding-top-100px padding-bottom-180px text-center">
      <div class="video-bg">
        <video autoplay loop>
          <source src="{{ asset('frontend/video/video-bg.mp4') }}" type="video/mp4" />
        ...
        <div class="row padding-top-50px">
          <div class="col-lg-4 responsive-column">
            <div class="card-item blog-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/blog-img.jpg') }}" alt="blog-img" />
              ...
              >
                <div class="author-content d-flex align-items-center">
                  <div class="author-img">
                    <img src="{{ asset('frontend/images/small-team1.jpg') }}" alt="testimonial image" />
                  </div>
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item blog-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/blog-img2.jpg') }}" alt="blog-img" />
                <div class="post-format icon-element">
              ...
              >
                <div class="author-content d-flex align-items-center">
                  <div class="author-img">
                    <img src="{{ asset('frontend/images/small-team2.jpg') }}" alt="testimonial image" />
                  </div>
                  <div class="author-bio">
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item blog-card">
              <div class="card-img">
                <img src="{{ asset('frontend/images/blog-img3.jpg') }}" alt="blog-img" />
                <div class="post-format icon-element">
              ...
              >
                <div class="author-content d-flex align-items-center">
                  <div class="author-img">
                    <img src="{{ asset('frontend/images/small-team3.jpg') }}" alt="testimonial image" />
                  </div>
                  <div class="author-bio">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="mobile-img">
              <img src="{{ asset('frontend/images/mobile-app.png') }}" alt="mobile-img" />
            </div>
          </div>
          <!-- end col-lg-5 -->
        </div>
          ...
          <div class="col-lg-12">
            <div class="client-logo">
              <div class="client-logo-item">
                <img src="{{ asset('frontend/images/client-logo.png') }}" alt="brand image" />
              </div>
              <!-- end client-logo-item -->
              <div class="client-logo-item">
                <img src="{{ asset('frontend/images/client-logo2.png') }}" alt="brand image" />
              </div>
              <!-- end client-logo-item -->
              <div class="client-logo-item">
                <img src="{{ asset('frontend/images/client-logo3.png') }}" alt="brand image" />
              </div>
              <!-- end client-logo-item -->
              <div class="client-logo-item">
                <img src="{{ asset('frontend/images/client-logo4.png') }}" alt="brand image" />
              </div>
              <!-- end client-logo-item -->
              <div class="client-logo-item">
                <img src="{{ asset('frontend/images/client-logo5.png') }}" alt="brand image" />
              </div>
              <!-- end client-logo-item -->
              <div class="client-logo-item">
                <img src="{{ asset('frontend/images/client-logo6.png') }}" alt="brand image" />
              </div>
              <!-- end client-logo-item -->
            </div>
            <!-- end client-logo -->
