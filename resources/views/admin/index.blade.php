...
<section class="content py-5" style="min-height: 700px;">
    <div class="row g-4">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm h-100" style="background: #8892D6">
                <div class="card-body d-flex justify-content-between align-items-end">
                    <div>
                        <h4 class="text-white mb-1">{{ $productcount }}</h4>
                        <h6 class="text-white mb-0">All Revenue</h6>
                    </div>
        ...
        {{-- Card: Orders --}}
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm h-100" style="background: #F06292">
                <div class="card-body d-flex justify-content-between align-items-end">
                    <div>
                        <h4 class="text-white mb-1">{{ $orders }}</h4>
                        <h6 class="text-white mb-0">All Earning</h6>
                    </div>
                    <div style="width: 45px; height: 50px;">
        ...
        {{-- Card: Users --}}
        <div class="col-xl-3 col-md-6">
            <div class="card  shadow-sm h-100" style="background: #45BBE0">
                <div class="card-body d-flex justify-content-between align-items-end">
                    <div>
                        <h4 class="text-white mb-1">{{ $users }}</h4>
                        <h6 class="text-white mb-0">All Booking</h6>
                    </div>
                    <div style="width: 45px; height: 50px;">
        ...
        {{-- Card: Doctors --}}
        <div class="col-xl-3 col-md-6">
            <div class="card  shadow-sm h-100" style="background: #78C350">
                <div class="card-body d-flex justify-content-between align-items-end">
                    <div>
